...
export default class HomeScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      listData: [],
      imagePath: "",
      url: `https://275a-2409-4064-e8a-6fcd-c843-e089-4a20-6e39.in.ngrok.io/planet?name=${this.props.navigation.getParam(
        "planets_name")}`
    };
  }
  ...
  renderItem = ({ item, index }) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={()=>
        this.props.navegation.navigate("Details",{planet_name:item.name})}
